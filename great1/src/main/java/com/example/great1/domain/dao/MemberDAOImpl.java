...
public class MemberDAOImpl implements MemberDAO {
     ...
     * @return 회원아이디
     */
    public String generateCustMemberId(){
        String sql = "select 'C-' || mem_num.nextval from dual ";
        String memNumber = jt.queryForObject(sql, String.class);
        return memNumber;
    }
     ...
     * @return 회원아이디
     */
    public String generateOwnMemberId(){
        String sql = "select 'O-' || mem_num.nextval from dual ";
        String memNumber = jt.queryForObject(sql, String.class);
        return memNumber;
    }
     ...
     */
    @Override
    public int joinCust(Member member) {
        int result = 0;
