...
public class UploadFileSVCImpl implements UploadFileSVC {
     ...
     */
    @Override
    public void addFile(List<MultipartFile> multipartFile, AttachCode code, Long rid) {
        //1) 스토리지 저장
        List<UploadFile> uploadFiles = fileUtils.multipartFileToUploadFiles(multipartFile, code, rid);
